...
TEST_FILE_PATH = "test_scan.nii.gz"
...
def check_results(result):
    ...
    # Check if we got the hardcoded simulated values
    # Simulated: NCR volume = 3618.4
    ncr_vol = seg_data.get("regions", {}).get("NCR", {}).get("volume_mm3", 0)
    
    print(json.dumps(seg_data, indent=2))
    
    if ncr_vol == 3618.4:
        print("\n⚠️  WARNING: Results match simulated data exactly.")
        print("The model inference might have failed or fallback was triggered.")
    else:
